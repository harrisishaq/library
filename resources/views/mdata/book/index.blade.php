        ...
        <div class="card-header">
          <div class="card-tools">
            <div class="float-right">
              <div class="btn-group">
                <a class="btn bg-primary font-weight-bold mr-1 mb-1" href="{{ url('mdata/book/add') }}">
                ...
                @if (count($data))
                  ...
                  <tr>
                    ...
                    <td style="text-align:center">
                      <a class="btn-sm bg-primary font-weight-bold mr-1 mb-1" href="{{ url('mdata/book/'.$d->id.'/edit') }}" data-toggle="tooltip" data-placement="top" title="Edit">
                        <i class="fas fa-edit"></i>
                      </a>
                      <a class="btn-sm bg-danger font-weight-bold ml-1 mb-1" href="{{ route('mdata.book.delete', $d->id) }}" data-method="DELETE" data-toggle="tooltip" data-placement="top" title="Delete">
