@extends('layouts.app')
@section('page-heading', __('Book & Library'))
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td style="text-align:center">
                    <a class="btn-sm bg-primary font-weight-bold mr-1 mb-1" href="{{ url('operational/book_library/'.$d->id.'/detail') }}" data-toggle="tooltip" data-placement="top" title="Detail">
                      Detail
                    </a>
                  </td>
                </tr>
